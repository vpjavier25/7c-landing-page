...
export default function NavBar() {
    ...
    return (
        <>
            <header className={`flex items-center justify-between  fixed top-0 right-0 z-50 w-full transition duration-300 ease-in-out ${isScrolled ? 'p-4 lg:p-4 bg-header lg:flex-row sm:gap-20 2xl:gap-40 lg:py-4 lg:justify-start' : isMenuOpen ? 'bg-header p-4 lg:p-4 gap-10 lg:flex-col lg:pt-10 lg:justify-start' : 'p-4 lg:p-4 gap-10 lg:flex-col lg:pt-10 lg:justify-start'}`}>
                <a href="#home">
            ...
            {isMenuOpen && (
                <>
                    ...
                    <ul className="flex flex-col justify-center items-center gap-5 text-gray-400 fixed pt-35 top-0 right-0 z-10 bg-header py-5 lg:hidden w-full">
